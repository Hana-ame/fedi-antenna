...
type User struct {
	...
	Endpoints   map[string]string `json:"endpoints" gorm:"-"`
...
// for local create, if foreign please create directly
func NewUser(name, host string) *User {
	return &User{
		...
		Endpoints: map[string]string{"sharedInbox": "https://" + host + "/inbox"},
...
func (o *User) Autofill() {
	...
	if o.Endpoints == nil {
		o.Endpoints = map[string]string{"sharedInbox": o.SharedInbox}
	}
}
