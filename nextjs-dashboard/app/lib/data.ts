...
export async function fetchCardData() {
  ...
  try {
    ...
    const invoiceCountPromise = prisma.$queryRaw<{count:string}[]>`SELECT COUNT(*) FROM invoices`;
    const customerCountPromise = prisma.$queryRaw<{count:string}[]>`SELECT COUNT(*) FROM customers`;
    const invoiceStatusPromise = prisma.$queryRaw<{paid:string, pending:string}[]>`SELECT
